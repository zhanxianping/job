            ...
            <el-menu
                ...
                <div v-for="(item,index) in sideNav.data" :key="item.id">
                    <el-submenu  :index="String(index)" v-if="item.nodes !== undefined && item.nodes.length >= 1">
                        ...
                        <SideNavList v-if="item.nodes !== undefined && item.nodes.length >= 1" :dataList="item.nodes" :listIndex="index"/>
                    </el-submenu>
        ...
        <div id="rightBox" :style="headerNav.sideNavOn ? 'margin-left: 70px;':'margin-left: 220px;'">
            <div id="headerNav" :style="'background-color:'+sideNav.color.headerNav">
                ...
                <div id="nav-content">
                    ...
                    <i class="el-icon-bell nav-news"></i>
                    <div class="nav-language">
                        <img src="../public/image/index/ChinaLogo.png" alt="">
                        <span>中文</span>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            //点击收起展开菜单栏
            navIconOn() {
                this.headerNav.sideNavOn = this.headerNav.sideNavOn ? false : true;
            },
            //头部展开动画
            navImgone(e) {
                this.headerNav.imgOne = this.headerNav.imgOne ? false : true;
